...
## Overview
# This repository contains the data processing scripts (Python) and statistical analysis code (R) for a study testing whether counties with more data centers tend to experience fewer FEMA disaster declarations, and whether this association varies by disaster type and over time.
